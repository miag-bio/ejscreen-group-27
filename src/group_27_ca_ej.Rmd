...
ggplot(data = ces, aes(x = white, y= ces_3_0_score))+
  ...
  labs(x = "Percentage of population that is white",
       y = "CES 3.0 score",
       caption = str_wrap("Gradient of CES 3.0 pollution scores by white population percentage. Darker colors indicate a higher density of observations. Data: Office of Environmental Health Hazard Assessment, California Environmental Protection Agency"))
```
